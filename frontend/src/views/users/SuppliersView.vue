                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="#"
                                    class="bg-gray-900 text-white hover:bg-gray-700 text-white rounded-md px-3 py-2 text-sm font-medium">Proveedores</a>
                                <!-- <a href="#" class="text-white-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Calendar</a>
                            <a href="#" class="text-white-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Reports</a> -->
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
